...
RQ2 앙상블 비교 (⚠️ 아래 ECE 값은 calibration leakage 수정 전 값, 수정 후 ECE ≈ 0.19):
- 선형 (α=0.5): Event F1 = 0.72, ECE = 0.04→0.19, 비용 = 120
- 최대:            Event F1 = 0.78, ECE = 0.06→0.19, 비용 = 95  ← 승자
- 곱:            Event F1 = 0.68, ECE = 0.03→0.19, 비용 = 140
...
- 보정 품질 (RQ2): `ECE < 0.05` (⚠️ 달성 못함, leakage 수정 후 ECE ≈ 0.19)
